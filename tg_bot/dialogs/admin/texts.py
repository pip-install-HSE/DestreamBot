...
add_group = lambda: _("Добавьте, пожалуйста, бота в группу.\nЕсли добавляете в канал - пожалуйста, перешлите после добавление любое сообщение из этого канала.")
established_as_admin = lambda: _(
    "Отлично, бот добавлен, теперь установите его в качестве администратора и нажмите на кнопку 'готово'.")
