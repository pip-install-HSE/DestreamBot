...
notify_yes = _("Хорошо! Поделюсь информацией о всех донатах и предложу выложить в группу.")
notify_no = _("Как скажите! Но не проблема будет посмотреть донаты на сайте, заходите...")
my_group = _("окей")
any_message = _("Отправьте /start для начала работы с ботом")